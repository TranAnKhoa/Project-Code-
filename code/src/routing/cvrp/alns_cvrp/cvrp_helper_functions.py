...
def read_input_cvrp(filename, instance_nr=0):
    ...
    for farm in farms:
        ...
        end_time = farm['time_windows']['PM'][1]
    ...
    distance_matrix = compute_distance_matrix(customer_coords_list)
    ...
    return (
        ...
        distance_matrix,        # Ma trận khoảng cách farm-farm
        distance_depots,        # Ma trận khoảng cách facility-farm
