...
EXCEL_FILE_PATH = r'E:\Syllabus for 2nd and 3rd year\cel\Project Code\output_data\haiz.xlsx'
...
PKL_OUTPUT_PATH = r'E:\Syllabus for 2nd and 3rd year\cel\Project Code\output_data\haiz.pkl'
# Tên các sheet
